...
\begin{frame}
  \begin{center}
    De onde vem o IC apresentado no exemplo?

    \bigskip
    O que é necessário para seu cálculo?
  \end{center}
\end{frame}
...
\begin{frame}{\scriptsize O Erro Padrão -- IC da média}
  \begin{exampleblock}{Exemplo 5.1}
    ...
    \begin{exampleblock}{}
      \begin{itemize}
        \tiny
      \item $\bar{x} = 123.4$ mmHg, $s = 14.0$ mmHg e $N = 100$
      \item $SEM = \frac{14}{\sqrt{100}} = 1.4$ mmHg
      \item $t^{*} \approx$ 2
      \end{itemize}
    \end{exampleblock}
    \begin{exampleblock}{}
      \begin{itemize}
        \tiny
      \item IC =  $123.4 \pm 2 \times 1.4$ mmHg
      \item IC =  $123.4 \pm 2.8$ mmHg
      \end{itemize}
    \end{exampleblock}
    \bigskip
    \begin{exampleblock}{}
...
\begin{frame}{\scriptsize Pense...}
  \begin{exampleblock}{Dados dos exemplos}
    \footnotesize
    \begin{itemize}
      \tiny
    \item {\bf Ex. 5.1:} $\bar{x}$ = 123,4 mmHg e $s$ = 14,0 mmHg ($N=100$)
    \item {\bf Ex. 5.2:} $\bar{x}$ = 99,0 mmHg e $s$ = 15,97 mmHg ($N=5$)
    \end{itemize}
  \end{exampleblock}
    \bigskip
  ...
  \begin{itemize}
    \footnotesize
  \item SEM do exemplo 5.1 = 1,4 mmHg $\Rightarrow$ IC: 120,6 -- 126,2 mmHg
  \item<2-> SEM do exemplo 5.2 = 6,3 mmHg? $\Rightarrow$ IC?
  \end{itemize}
  \end{block}
\end{frame}
...
\begin{frame}{\scriptsize }
  ...
  \begin{itemize}
    \footnotesize
  \item SEM do exemplo 5.1 = 1,4 mmHg
  \item SEM do exemplo 5.2 = 6,3 mmHg
  \end{itemize}
  \end{block}
  \bigskip
  \visible<2->{
  \begin{block}{Resposta}
    \footnotesize
    {\bf Não!} \visible<3->{Pois N=5 não é grande!} \visible<4>{\hfill {\tiny E daí?}}

    \medskip
    \visible<5->{
    Isso faz com que a aproximação $t^{*} \approx 2$ não seja válida.
    }
  \end{block}
  }
...
\begin{frame}{\scriptsize }
  \begin{exampleblock}{Lembrete -- ICs dos exemplos}
    ...
    \begin{itemize}
      \tiny
    \item O IC do exemplo 5.1: 120,6 -- 126,2 mmHg
    \item O IC do exemplo 5.2: \alert{\footnotesize 79,2 -- 118,8 mmHg}
    \end{itemize}
  \end{exampleblock}
  \begin{block}{No caso do exemplo 5.2}
    ...
    \begin{itemize}
      \tiny
    \item {\bf $\bar{x}$ = 99 mmHg}, SEM $\approx$ 6 mmHg
    \item A margem de erro seria {\footnotesize {\bf 2} $\times $ 6 $\approx$ 12 mmHg}
    \end{itemize}
    \medskip
...
\begin{frame}{\scriptsize }
  ...
  \begin{block}{No caso do exemplo 5.2}
    ...
    \item O IC proposto seria \alert{\footnotesize 87 -- 111 mmHg}
    \end{itemize}
    \medskip
    $t^{*} \approx$ 2 $\Rightarrow$ erro no 5.2
  \end{block}
  \begin{block}{Pense...}
    \footnotesize
...
\begin{frame}{\scriptsize A estatística t}
  \begin{block}{}
    Esse $t^{*}$ é uma {\em estatística}...
