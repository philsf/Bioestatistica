...
\begin{frame}{Na prática...}
  \begin{center}
    \includegraphics[height=\textheight]{modelos/pratica-plot1}
  \end{center}
\end{frame}

\begin{frame}{Na prática...}
  \begin{center}
    \includegraphics[height=\textheight]{modelos/pratica-plot2}
  \end{center}
\end{frame}

\begin{frame}{Na prática...}
  \begin{center}
    \includegraphics[height=\textheight]{modelos/pratica-plot3}
  \end{center}
\end{frame}
