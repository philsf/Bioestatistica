...
\begin{frame}{Para todos os gostos...}
  \begin{center}
    \includegraphics[height=.9\textheight]{modelos/modelos-table1}
  \end{center}
\end{frame}
...
\begin{frame}{Depois dos comerciais...}
  \begin{center}
    \includegraphics[width=\textwidth]{modelos/bmi-bmd-title}
  \end{center}
\end{frame}

\begin{frame}{Depois dos comerciais...}
  \begin{center}
    \includegraphics[width=1.175\textwidth]{modelos/bmi-bmd-abstract}
  \end{center}
\end{frame}
...
\begin{frame}{Na prática...}
  \begin{columns}
    ...
    \begin{column}{5cm}
      \begin{center}
        \includegraphics[width=\textwidth]{modelos/pratica-plot1}
      \end{center}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Resíduos}
  \begin{center}
      \includegraphics[height=0.6\textheight]{modelos/residuos}
  \end{center}
...
\begin{frame}{Exemplo}
  \centering
  \includegraphics[width=.9\textwidth]{modelos/regressao1}
...
\begin{frame}{Exemplo}
  \centering
  \includegraphics[width=1.2\textwidth]{modelos/regressao2}
\end{frame}
...
\begin{frame}{Análise de Regressão}
  \begin{center}
      \includegraphics[height=0.6\textheight]{modelos/residuos2}
  \end{center}
...
\begin{frame}{Na prática...}
  \begin{center}
    \includegraphics[height=.9\textheight]{modelos/pratica-plot1}
  \end{center}
\end{frame}

\begin{frame}{Na prática...}
  \begin{center}
    \includegraphics[height=.9\textheight]{modelos/pratica-plot2}
  \end{center}
\end{frame}
...
\begin{frame}{E o BMI = 28?}
  \begin{center}
    \includegraphics[height=.9\textheight]{modelos/pratica-plot3}
  \end{center}
\end{frame}
