...
\begin{frame}[fragile]{Diagnosticando a regressão}
  ...
  \begin{exampleblock}{Resposta}
    \begin{itemize}
      \footnotesize 
    \item Podemos explicar $r^2$ = 57\% da variância observada no BMD
...
\begin{frame}{E o BMI = 39?}
  \begin{columns}
    \begin{column}{5cm}
      \begin{itemize}
        \small
      \item o valor predito pelo modelo é 221.8968
...
\begin{frame}{\small Dispersão em torno da reta {\bf cresce} ao longo da faixa ($r^2$ = 42\%)}
  \begin{center}
    \includegraphics[height=.9\textheight]{Cap18-19/pratica-plot-heterocedasticidade}
  \end{center}
\end{frame}

\begin{frame}{\small Dispersão em torno da reta {\bf varia} ao longo da faixa ($r^2$ = 29\%)}
  \begin{center}
