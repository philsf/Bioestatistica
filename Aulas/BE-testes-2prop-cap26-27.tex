...
\includegraphics[height=\textheight]{Teste_qui2/qui-quadrado1}
\end{frame}
...
\begin{frame}{A tabela Qui-Quadrado}
  \includegraphics[height=\textheight]{Teste_qui2/qui-quadrado2}
\end{frame}
...
\begin{frame}{Visualização - gráfico de barra}
  \begin{center}
    \includegraphics[height=\textheight]{Teste_qui2/barplot}
  \end{center}
\end{frame}
...
\begin{frame}{Leitura pós-aula e exercícios selecionados}
  \begin{block}{Leitura obrigatória}
    \begin{itemize}
    \item Capítulo 26.
    \item Capítulo 27, pular as seções: Calculando o poder
    \end{itemize}
  \end{block}
