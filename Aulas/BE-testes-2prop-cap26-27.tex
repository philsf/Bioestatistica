...
\begin{frame}{\small Expectativa x Realidade}
  \begin{block}{Observação}
    ...
    \end{itemize}
    \bigskip
    \uncover<0>{\begin{block}{}
      Quanto maior o valor de de $\chi^2$, maior a discrepância
    \end{block}}
  \end{block}
\end{frame}
...
\begin{frame}{\scriptsize O teste exato de Fisher}
  \begin{itemize}
    \footnotesize
...
\begin{frame}{\scriptsize Tabelas de contingência maiores}
  \begin{itemize}
    \scriptsize
  \item Estatística de teste $\chi^2 = 21.62$
  \item p-valor $p<0.001$ %(valor fora da tabela)
