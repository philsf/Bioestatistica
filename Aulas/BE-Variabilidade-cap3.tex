  ...
  \begin{exampleblock}{Exemplo}
    \begin{columns}
      ...
      \begin{column}{5cm}
        ...
        \alert{\bf 19} ao invés de \alert{\bf 139}?
...
\begin{frame}[fragile]{\scriptsize Dados}
  \begin{exampleblock}{\scriptsize Pressão sanguínea (N = 6, média 146)}
    \begin{center}
    \tiny
\begin{verbatim}
144 146 139 155 144 146
\end{verbatim}
    \bigskip
...
\begin{frame}[fragile]{\scriptsize Desvios em relação à média}
  \begin{block}{Pressão sanguínea (N = 6, média 146)}
    \footnotesize
\begin{verbatim}
144 146 139 155 144 146
\end{verbatim}
...
\begin{frame}{\scriptsize Desvio médio absoluto (MAD)}
  \begin{exampleblock}{Exemplo}
    \footnotesize
  \begin{displaymath}
    \{144, 146, 139, 155, 144, 146\}, \bar{x} = 146
  \end{displaymath}
  \begin{columns}
    \begin{column}{5cm}<1->
      \begin{enumerate}
    ...
    \begin{column}{5cm}
      \begin{displaymath}
        \mathrm{MAD} = \frac{\sum |D_i|}{6} = \frac{20}{6} = 3
      \end{displaymath}
    \end{column}
  \end{columns}
\end{exampleblock}
