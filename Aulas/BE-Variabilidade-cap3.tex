...
\begin{frame}{\scriptsize Medida de dispersão de dados não paramétricos}
  \begin{block}{Descrição de dados amostrais}
    ...
    \item Dados ``mal comportados''
      \begin{itemize}
        \scriptsize
      \item Mediana e Amplitude Inter Quartílica ($M_d$ e AIQ {\tiny IQR em inglês})
      \item Mediana e Intervalo Inter Quartílico ($M_d$ e IIQ)
      \end{itemize}
    \end{itemize}
  \end{block}
\end{frame}
...
\begin{frame}{\scriptsize Quiz}
  \begin{block}{Pergunta}
    ...
    \item Variância ($s^2$)
    \item Intervalo Interquartílico
