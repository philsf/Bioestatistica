...
\begin{frame}[fragile]{Dados}
  \begin{block}{medida do músculo (N = 32)}
\begin{verbatim}
...
\begin{frame}[fragile]{Desvios em relação à média}
  \begin{block}{Desvios em relação à média (90)}
\begin{verbatim}
"1.77"  "-0.74" "-1.08" "-6.49" "1.63"
"0.23"  "-8.83" "3.73"  "3.25"  "0.58"
"0.23"  "-2.97" "0.76"  "9.33"  "1.77"
"-6.33" "-4.22" "-4.20" "-1.04" "-0.67"
"-0.73" "6.41"  "7.12"  "0.93" "-0.03"
"-3.10" "3.04"  "3.65"  "-4.71" "6.19"
"1.26"  "-6.75"
\end{verbatim}
  \end{block}
\end{frame}
