...
\begin{frame}{O teste t: características}
  \begin{itemize}
  \item Distribuição: t de Student
  \item Hipótese: não há diferença entre as duas médias
  \item Estatística de teste: $t = \frac{\bar{x}}{SE}$
  \end{itemize}
  \vfill
  \begin{block}{Interpretação da estatística de teste}
    ...
    \bigskip
    ... maior a discrepância entre as médias observadas ({\footnotesize considerando a variabilidade do experimento}).
  \end{block}
\end{frame}

\begin{frame}{Teste t para uma amostra}
  \begin{center}
    \large
...
\begin{frame}{\small Caso de você tenha escolhido grupos independentes...}
  \begin{center}
    \LARGE
