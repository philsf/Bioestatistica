...
\begin{frame}{\scriptsize Região crítica}
  ...
  \end{center}
  % https://onlinecourses.science.psu.edu/statprogram/book/export/html/528

  \begin{itemize}
    \tiny
%  \item $\alpha = 0.05$ (dividido em cada cauda da distribuição)
  \item t crítico: $t^{*} = \pm 2.14479$ (bicaudal)
  \item região crítica: $t < -2.14479$ ou $t > 2.14479$
  % \item definidos pelas hipóteses nula e alternativa
  \end{itemize}
\end{frame}
