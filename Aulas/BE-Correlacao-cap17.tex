...
\begin{frame}{Visualização - Dispersão ``pequena''}
  \begin{center}
    \includegraphics[height=.8\textheight]{Cap17/dot-P}
  \end{center}
\end{frame}

\begin{frame}{Visualização - Dispersão ``média''}
  \begin{center}
    \includegraphics[height=.8\textheight]{Cap17/dot-M}
  \end{center}
\end{frame}

\begin{frame}{Visualização - Dispersão ``grande''}
  \begin{center}
...
\begin{frame}{Visualização - Dispersão ``pequena'' - boxplot}
  \begin{center}
    \includegraphics[height=.8\textheight]{Cap17/dot-box-P}
  \end{center}
\end{frame}

\begin{frame}{Visualização - Dispersão ``média'' - boxplot}
  \begin{center}
    \includegraphics[height=.8\textheight]{Cap17/dot-box-M}
  \end{center}
\end{frame}

\begin{frame}{Visualização - Dispersão ``grande'' - boxplot}
  \begin{center}
...
\begin{frame}{Dispersão ``conjunta'' entre duas variáveis}
  \small
  \begin{itemize}
  \item Pareando no mesmo gráfico duas amostras, podemos observar simultaneamente
    \begin{itemize}
...
\begin{frame}{Visualização - Dispersão conjunta ``inexistente''}
  \begin{center}
...
\begin{frame}{Visualização - Dispersão de amostras independentes}
  \begin{center}
