...
\begin{frame}{Introdução}
  \begin{block}{Dante}
    ...
    Encontra aí a figura de Virgílio, o poeta latino que, a pedido da alma beata de Beatriz, o grande amor da juventude de Dante, vem se lhe oferecer como guia para o Inferno e o Purgatório onde, pelo exemplo dos pecadores e de suas penas, Dane poderá encontrar o caminho da sua salvação.''}
  \end{block}
\end{frame}
...
\begin{frame}{Identificando hipóteses}
  ...
  \end{exampleblock}
  \begin{center}
      \only<2->{\includegraphics[height=2cm]{Jackie-Chan-WTF}}
  \end{center}
\end{frame}
