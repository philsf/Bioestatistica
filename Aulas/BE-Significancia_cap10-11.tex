...
\begin{frame}{Exemplo 2}
  \begin{exampleblock}{Resultado}
    \small Rejeitamos a hipótese de que a quantidade média de ácido
    acetil salicílico (gramas por comprimido) de certo analgésico é
    igual a 5.5 gramas ao nível de significância de 5\%.
  \end{exampleblock}
  \begin{exampleblock}{Conclusão}
    O lote deste medicamento está fora da especificação de 5.5 gramas/comprimido.
  \end{exampleblock}
\end{frame}
