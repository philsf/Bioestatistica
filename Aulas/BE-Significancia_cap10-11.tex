...
\begin{frame}{\scriptsize Requisitos do cálculo amostral}
  \begin{block}{\scriptsize Diferença em desfecho qualitativo}
    \begin{itemize}
      \footnotesize
    ...
    \item Tamanho do efeito relevante
      ...
      {\tiny diminuir de 80\% para 70\% \hfill $\bar{d}=10\%$}
    \end{itemize}
  \end{block}
  \bigskip
  
  \begin{block}{\scriptsize Diferença em desfecho quantitativo}
    \begin{itemize}
      \footnotesize
    ...
    \item Tamanho do efeito relevante
      ...
      {\tiny diminuir de 1.2 para 1.1 segundos \hfill $\bar{d} = 0.1$ segundos}
    \end{itemize}
  \end{block}
\end{frame}
