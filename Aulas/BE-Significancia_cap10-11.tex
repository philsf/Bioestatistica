  ...
  \begin{columns}
    ...
    \begin{column}{5cm}
      \begin{exampleblock}{\scriptsize Mais tempo, mais objetos detectados?}
        \centering
        \visible<2,4>{
        \includegraphics[width=.35\textwidth]{Cap10-11/analogia-poder-var100-pq}
      }
      \end{exampleblock}
    \end{column}
  \end{columns}
  ...
  \begin{columns}
    ...
    \begin{column}{5cm}
      \begin{exampleblock}{\scriptsize Efeito grande}
        \centering
        \includegraphics[width=\textwidth]{Cap10-11/analogia-poder-var100}
      \end{exampleblock}
    \end{column}
  \end{columns}
  \vfill
  ...
  \begin{columns}
    ...
    \begin{column}{5cm}
      \begin{exampleblock}{\scriptsize Menos variabilidade}
        \centering
        \includegraphics[width=\textwidth]{Cap10-11/analogia-poder-var085}
      \end{exampleblock}
    \end{column}
  \end{columns}
  \vfill
  ...
  \begin{columns}
    ...
    \begin{column}{5cm}
      \begin{exampleblock}{\scriptsize Pouca variabilidade}
        \centering
        \includegraphics[width=\textwidth]{Cap10-11/analogia-poder-var050}
      \end{exampleblock}
    \end{column}
  \end{columns}
  \vfill
...
\begin{frame}{\scriptsize }
  ...
  \item<3-> A capacidade da ferramenta em detectá-lo depende...
    ...
    \item<3-> da variabilidade presente \visible<4>{$(s)$ \hfill({\tiny aula 3})}
      \smallskip
    \item<3-> do tamanho do efeito relevante \visible<4>{$(d)$ \hfill({\tiny aula 5})}
      \smallskip
