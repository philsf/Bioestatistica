...
\begin{frame}{Exemplo 2}
  \begin{block}{Interpretação}
    ...
    Rejeitamos a hipótese de que a quantidade média é igual a 5.5
    gramas ao nível de significância de 5\%.
  \end{block}
  ...
  \begin{exampleblock}{Conclusão}
    O lote (...)
    % deste medicamento
    está fora da especificação de 5.5 gramas/comprimido, portanto o lote está reprovado.
  \end{exampleblock}
\end{frame}
