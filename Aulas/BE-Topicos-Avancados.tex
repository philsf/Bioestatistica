...
\begin{frame}{Esses 3 grupos têm médias diferentes, controlando por Gênero?}
  \begin{center}
    \includegraphics[height=.9\textheight]{Topicos_adv/cenario12}
  \end{center}
\end{frame}

\begin{frame}{Esses 3 grupos têm médias diferentes, controlando por Gênero?}
  \begin{center}
    \includegraphics[height=.9\textheight]{Topicos_adv/cenario12_medias}
...
\begin{frame}
  \begin{center}
    \includegraphics[height=.9\textheight]{Topicos_adv/cenario22}
  \end{center}
\end{frame}

\begin{frame}{E estes 3 grupos?}
  \begin{center}
    \includegraphics[height=.9\textheight]{Topicos_adv/cenario22_medias}
...
\begin{frame}[fragile]{Exercício}
  \begin{exampleblock}{Cenário 1 - ANOVA}
    \tiny
\begin{verbatim}
            Df Sum Sq Mean Sq F value Pr(>F)  
Grupo        2  3.753  1.8763   3.025 0.0701 .
...
\end{verbatim}
    \begin{center}
      \includegraphics[height=.5\textheight]{Topicos_adv/cenario1}
    \end{center}
  \end{exampleblock}
\end{frame}

\begin{frame}[fragile]{Exercício}
  \begin{exampleblock}{Cenário 2 - ANOVA}
    \tiny
\begin{verbatim}
            Df Sum Sq Mean Sq F value Pr(>F)  
Grupo        2  9.499   4.749   4.775 0.0195 *
...
\end{verbatim}
    \begin{center}
      \includegraphics[height=.5\textheight]{Topicos_adv/cenario2}
    \end{center}
  \end{exampleblock}
\end{frame}
...
\end{verbatim}
    \begin{center}
      \includegraphics[height=.5\textheight]{Topicos_adv/cenario22}
    \end{center}
  \end{exampleblock}
\end{frame}
