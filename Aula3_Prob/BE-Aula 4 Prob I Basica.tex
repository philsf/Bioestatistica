...
\begin{frame}{Eventos compostos}
  ...
  \begin{figure}
    \centering
    \includegraphics[height=0.6\textheight]{ervilhas-genetica}    
...
\begin{frame}{Eventos mutuamente exclusivos}
  ...
  \begin{figure}
    \centering
    \includegraphics[height=0.4\textheight]{venn}
    \caption{Fonte: Triola, 2004.}
  \end{figure}
\end{frame}
...
\begin{frame}{Eventos dependentes}
  ...
  \begin{figure}
    \centering
    \includegraphics[height=0.5\textheight]{ervilhas-genetica}
    \caption{Fonte: Triola, 2004.}
  \end{figure}
\end{frame}
...
\begin{frame}{Exercícios}
  \begin{block}{Solução}
    ...
    \item P(positivo$|$grávida) = 
      \begin{displaymath}
        \frac{\frac{80}{99}}{\frac{85}{99}} = \frac{85}{99}=0.94
      \end{displaymath}
      Alternativamente, apenas consultando a tabela:
      P(positivo$|$grávida) = $\frac{80}{85}=0.941$

    \item P(grávida$|$positivo) = $\frac{80}{83}= 0.964$
    \end{enumerate}
  \end{block}
\end{frame}
